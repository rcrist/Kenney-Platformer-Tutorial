![[Pasted image 20260925061410.png]]

## AI Background Image
---
![[robowser_fortress.png|1000]]

## Test Level
---
![[Pasted image 20260925062705.png|1000]]

Tileset is from Kenny > Platformer Assets Tile Extensions > PNG Castle

Level 04 - Tilemap
Map Size: 80x20 Tiles (Biggest level)
Tile Size: 70x70 px
...
![[Pasted image 20260925082250.png]]

<video src=20260925-1423-45.4367934.mp4 controls width="1000"></video>
...
class GameView(arcade.View):
    ...
    def load_enemies(self):
        ...
        enemy_markers = []
        try:
            sprite_markers = self.level.scene.get_sprite_list("Enemies")
        except KeyError:
            sprite_markers = ()
        ...
        for marker in self.level.tile_map.object_lists.get("Enemies", ()):
        ...
        for properties, marker_position in enemy_markers:
            ...
            if enemy_type in ENEMY_TEXTURES:
                ...
                if enemy_type == "robobowser":
                    ...
                    enemy.scale = 0.5
                enemy.is_flying = enemy_type in ("bat", "fly") or enemy_type.startswith("saucer")
            else:
