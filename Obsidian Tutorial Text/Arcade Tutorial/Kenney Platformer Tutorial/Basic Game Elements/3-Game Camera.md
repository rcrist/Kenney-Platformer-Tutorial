Create a viewport camera that displays a portion of the screen at the full window resolution.

![[Pasted image 20260922142031.png|1000]]

```python title=3_game_camera.py
import arcade
